...
- `AI_STACK_ADDITIVE_FEATURE_2026-08-27.md` — first controlled substantive additive-feature benchmark: Qwen3-Coder failed under OpenCode, Aider, and Pi in distinct ways, while Pi + Qwen3.8 completed the same frozen contract with hidden acceptance, 726 tests, Ruff, mypy, and diff-check all passing; this validates Pi + Qwen3.8 for this task class while leaving Aider + Qwen3.8 as the next harness-isolation experiment.
